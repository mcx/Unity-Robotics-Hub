...
from niryo_one_msgs.msg import RobotMoveAction, RobotMoveActionGoal, ToolCommand, TrajectoryPlan
...
def send_action_goal(client, trajectory):
...
def send_tool_command(client, gripper_command):
...
def plan_pick_and_place(req):
    ...
    send_action_goal(client, pre_grasp_pose)
    ...
    send_action_goal(client, grasp_pose)


    send_tool_command(client, CLOSE_COMMAND)
    ...
    send_action_goal(client, pick_up_pose)
    ...
    send_action_goal(client, pre_place_pose)
